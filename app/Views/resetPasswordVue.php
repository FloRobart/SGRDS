...
<div class="container py-5 px-md-5 text-bg-light w-75 w-md-50  ">
    <form action="<?php echo base_url(); ?>forgot_password/update_password" id="connexionForm" method="post" class="rounded border py-5 px-md-5 text-bg-white text-center">
